...
<section class="contact-seller py-5">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-md-3 justify-content-md-end gap-15 d-flex align-items-center">
                <a href="javascript: void()" data-toggle="modal" data-target="#reason" class="text-theme-primary reasonRejected">Rejected Reason</a>
                <p class="mb-0"><span class="order-status text-pending"></span></p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="cta">
                    <div class="d-flex gap-15 flex-wrap">
                        <a href="../car-inspection/" class="btn-theme-solid">Inspect This Car</a>
                        <a href="#" class="btn-theme-outline">Test Drive Request</a>
                    </div>
                </div>
                <!-- car fetaues list  -->
