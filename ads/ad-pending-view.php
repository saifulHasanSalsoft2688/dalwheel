                        ...
                        <div class="col-md-10 px-md-1">
                            ...
                            <div class="adopt-pet-detail mb-4 mx-10">
                                <div class="row justify-content-between">
                                    <div class="col-md-12">
                                        <div class="title-pet-box d-flex gap-15 flex-wrap align-items-center">
                                            <h3 class="mb-0">Kathy Lewis Baby</h3>
                                            <p class="tag-btn mb-0 bg-inactive">In-Active</p>
                                        </div>
                                        ...
                                        <div class="mile-box">
                                            ...
                                            <p class="text-secondary mb-0">Donated To Max</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row justify-content-between">
                                    <div class="col-md-12">
                                        ...
                                        <div class="viewPin text-center mt-4">
                                            <button class="secondary-theme-button shadow btn bg-brown py-2">View Offer</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
