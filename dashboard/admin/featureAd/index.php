    ...
    <div class="container-fluid">
        <div class="box">
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                <h1 class="section-heading font-commons my-3">Feature Ad Packages</h1>
                <a href="./addPackageDetails.php" class="main-btn my-3">Add Plan</a>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="dropdown-menu tdDropDown">
                                    <a class="dropdown-item" href="./packageDetails.php"><i class="far fa-eye "></i>View</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
