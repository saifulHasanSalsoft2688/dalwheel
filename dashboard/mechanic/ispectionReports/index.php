...
<div class="configuration">
    <div class="container-fluid">
        <div class="box">
            <h1 class="section-heading font-commons my-3">Inspection Reports</h1>
                ...
                <table class="table table-borderless w-100">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>MM/DD/YYYY</td>
                            <td>abc xyz</td>
                            <td>Workshop Inspection</td>
                            <td class="colGreen">Completed</td>
                            <td>Sun 12:00 pm - 3:00PM</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="dropdown-menu tdDropDown">
                                    <a class="dropdown-item" href="./reports.php"><i class="far fa-eye "></i>View</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
