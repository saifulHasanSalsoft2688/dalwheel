            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="listing-title mb-3">
                        <h5 class="">Home <i class="fa fa-chevron-right"></i> Used Cars <i class="fa fa-chevron-right"></i> <span>Toyota Prius 2022</span> <i class="fa fa-chevron-right"></i> <span class="text-danger">Inspection Report</span> </h5>
                    </div>
                </div>
            </div>
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                <h3 class="font-weight-bold">Car Details</h3>
                <a class="nav-link secondary-theme-button shadow mx-md-4" href="#">View Ad</a>
            </div>
            <!--  -->
            <div class="row my-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-10">
                            <div class="accordion customAccordion my-4" id="accordionExample">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="accDiv1" data-parent="#accordionExample">
                        ...
                        <div class="col-xl-6 col-lg-10">
                            <div class="accordion customAccordion my-4" id="accordionExample2">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapsetwo" class="accordion-collapse collapse" aria-labelledby="accDiv2" data-parent="#accordionExample2">
                                        <div class="accordion-body">
                                            <div class="d-flex align-items-center justify-content-between border accordionContent">
                        ...
                        <div class="col-xl-6 col-lg-10">
                            <div class="accordion customAccordion my-4" id="accordionExample">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="accDiv3" data-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <div class="d-flex align-items-center justify-content-between border accordionContent">
                        ...
                        <div class="col-xl-6 col-lg-10">
                            <div class="accordion customAccordion my-4" id="accordionExample2">
                                <div class="accordion-item">
                                    <div class="accordion-header" id="accDiv2">
                                        <button class="accordion-button" type="button" data-toggle="collapse" data-target="#collapsefour" aria-expanded="true" aria-controls="collapsefour">
                                            <span class="d-flex align-items-center justify-content-between w-100 px-1">
                                    ...
                                    <div id="collapsefour" class="accordion-collapse collapse" aria-labelledby="accDiv2" data-parent="#accordionExample2">
                                        <div class="accordion-body">
                                            <div class="d-flex align-items-center justify-content-between border accordionContent">
                        ...
                        <div class="col-xl-6 col-lg-10">
                            <div class="accordion customAccordion my-4" id="accordionExample2">
                                <div class="accordion-item">
                                    <div class="accordion-header" id="accDiv2">
                                        <button class="accordion-button" type="button" data-toggle="collapse" data-target="#collapsefive" aria-expanded="true" aria-controls="collapsefive">
                                            <span class="d-flex align-items-center justify-content-between w-100 px-1">
                                    ...
                                    <div id="collapsefive" class="accordion-collapse collapse" aria-labelledby="accDiv2" data-parent="#accordionExample2">
                                        <div class="accordion-body">
                                            <div class="d-flex align-items-center justify-content-between border accordionContent">
                                                <p class="mb-0">Horn </p>
                                                <p class="mb-0 colGreen">Working</p>
                        ...
                        <div class="col-xl-6 col-lg-10">
                            <div class="accordion customAccordion my-4" id="accordionExample2">
                                <div class="accordion-item">
                                    <div class="accordion-header" id="accDiv2">
                                        <button class="accordion-button" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix">
                                            <span class="d-flex align-items-center justify-content-between w-100 px-1">
                                    ...
                                    <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="accDiv2" data-parent="#accordionExample2">
                                        <div class="accordion-body">
                                            <div class="d-flex align-items-center justify-content-between border accordionContent">
                        ...
                        <div class="col-xl-6 col-lg-10">
                            <div class="accordion customAccordion my-4" id="accordionExample2">
                                <div class="accordion-item">
                                    <div class="accordion-header" id="accDiv2">
                                        <button class="accordion-button" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven">
                                            <span class="d-flex align-items-center justify-content-between w-100 px-1">
                                    ...
                                    <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="accDiv2" data-parent="#accordionExample2">
                                        <div class="accordion-body">
                                            <div class="d-flex align-items-center justify-content-between border accordionContent">
                        ...
                        <div class="col-xl-6 col-lg-10">
                            <div class="accordion customAccordion my-4" id="accordionExample2">
                                <div class="accordion-item">
                                    <div class="accordion-header" id="accDiv2">
                                        <button class="accordion-button" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="true" aria-controls="collapseEight">
                                            <span class="d-flex align-items-center justify-content-between w-100 px-1">
                                    ...
                                    <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="accDiv2" data-parent="#accordionExample2">
                                        <div class="accordion-body">
                                            <div class="d-flex align-items-center justify-content-between border accordionContent">
                        ...
                        <div class="col-xl-6 col-lg-10">
                            <div class="accordion customAccordion my-4" id="accordionExample2">
                                <div class="accordion-item">
                                    <div class="accordion-header" id="accDiv2">
                                        <button class="accordion-button" type="button" data-toggle="collapse" data-target="#collapseNine" aria-expanded="true" aria-controls="collapseNine">
                                            <span class="d-flex align-items-center justify-content-between w-100 px-1">
                                    ...
                                    <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="accDiv2" data-parent="#accordionExample2">
                                        <div class="accordion-body">
                                            <div class="d-flex align-items-center justify-content-between border accordionContent">
                                                <p class="mb-0">Rims </p>
