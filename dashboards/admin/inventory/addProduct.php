        ...
        <div class="box my-4">
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                <div class="d-flex align-items-center my-3 section-heading">
                    ...
                    <h6 class="section-heading mb-0">Add Product</h6>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea type="number" id="desc" rows="8" class="primary-inputs secInp" placeholder="Enter Discription"></textarea>
                        </div>
                        <div class="mb-4">
                            <label class="d-block prime-label mb-3" for="desc">Picture</label>
                            <div class="d-flex align-items-end">
                                <div class="upload_product d-none">
                                ...
                                <button class="notBtn uploadFile" type="button" onclick="document.getElementById('uploadFile').click()"><i class="fas fa-upload"></i></button>
                                <input id="uploadFile" type="file" id="file-ip-1" accept="image/*" onchange="showPreview2(event);" class="d-none">
                            </div>
                        </div>
                        <button class="main-btn mt-3" type="button" type="button" data-bs-toggle="modal" data-bs-target="#productAdded">Add</button>
                    </div>
                </div>
            </form>
        </div>
