...
<div class="configuration">
    <div class="container-fluid">
        <div class="box">
            <h1 class="section-heading font-commons my-3">Queries Management</h1>
                    ...
                    <div class="custom_canvas my-3">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                            ...
                            <div class="offcanvas-body customfilters px-5">
                                ...
                                <div class="my-3">
                                    <label for="adStatus" class="d-block mb-1">Filter By User Type</label>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="dropdown-menu tdDropDown">
                                    <a class="dropdown-item" href="queryDetails.php"><i class="far fa-eye "></i>View</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
