                ...
                <div class="col-xxl-5 col-xl-6 col-md-8">
                    <form action="#">
                        <div class="mb-4">
                            ...
                            <input type="text" id="subCatName" class="primary-inputs secInp" placeholder="Enter Plan Name" value="">
                        </div>
                        <div class="mb-4">
                            <label class="d-block prime-label mb-3" for="subCatName">Days<span class="text-danger">*</span> </label>
                            <input type="number" id="subCatName" class="primary-inputs secInp" placeholder="Enter Days" value="">
                        </div>
                        <div class="mb-4">
                            <label class="d-block prime-label mb-3" for="subCatName">Price<span class="text-danger">*</span> </label>
                            <input type="number" id="subCatName" class="primary-inputs secInp" placeholder="Enter Price" value="">
                        </div>
                        <button class="main-btn mt-3" type="button" data-bs-toggle="modal" data-bs-target="#packageAdded">Add Package</button>
                    </form>
                </div>
            </div>
        </div>
