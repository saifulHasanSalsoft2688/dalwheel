...
<div class="configuration">
    <div class="container-fluid">
        <div class="box">
            <h1 class="section-heading font-commons my-3">Ads Management</h1>
                ...
                <table class="table table-borderless w-100">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="dropdown-menu tdDropDown">
                                    <a class="dropdown-item" href="./approvedAdDetails.php"><i class="far fa-eye "></i>View</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>abc xyz</td>
                            <td>MM/DD/YYYY</td>
                            <td class="colYellow">Pending</td>
                            <td>
                                <button type="button" class="notBtn" data-bs-toggle="dropdown">
                                    <i class="fa fa-ellipsis-v opt_icon"></i>
                                </button>
                                <div class="dropdown-menu tdDropDown">
                                    <a class="dropdown-item" href="pendingAdDetails.php"><i class="far fa-eye "></i>View</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="dropdown-menu tdDropDown">
                                    <a class="dropdown-item" href="./rejectedAdDetails.php"><i class="far fa-eye "></i>View</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
