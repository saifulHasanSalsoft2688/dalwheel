...
<section class="cart py-5">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-3">
                <p class="mb-0 font-weight-bold f-18">Status: <span class="text-success">Delivered</span></p>
            </div>
            ...
            <div class="col-md-9">
                <div class="cart-detail shadow p-3 h-100">
                        ...
                        <table class="table text-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        $820
                                        <p class="mb-0"><a class="text-info" href="javascript: void()" data-toggle="modal" data-target="#review"> Write Review</a></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                    ...
                    <div class="reportAd text-center">
                        <p><a class="text-danger" href="javascript: void()" data-toggle="modal" data-target="#reportAd"><i class="fa fa-warning pr-1"></i> Report Your Order</a></p>
                    </div>
                </div>
            </div>
